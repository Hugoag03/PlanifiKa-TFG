...
public class ConsultarTareas extends javax.swing.JFrame {
    ...
    public ConsultarTareas() {
        ...
        try {
            ...
            PreparedStatement ps = cn.prepareStatement("SELECT * FROM tareas WHERE ID_Proyecto = ?");
    ...
    /*
        EspaciadoTablas espaciadoRenderer = new EspaciadoTablas(30); 
        for (int i = 0; i < tdConsultarTrabajador.getColumnCount(); i++) {
            tdConsultarTrabajador.getColumnModel().getColumn(i).setCellRenderer(espaciadoRenderer);
        }
     */
    @Override
    ...
    private void initComponents() {
        ...
        PanelFondo.add(labelFondo, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1400, 790));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultarTareas.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConsultarTareas().setVisible(true);
            }
        });
    }
